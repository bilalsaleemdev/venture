        ...
        <>
            ...
            <div className="overflow-x-auto w-full ">
                ...
                <table className="table w-full ">
                    <thead >
                    <tr className="h-[45px]">
                        <th> <span className="flex"><input type="checkbox" name="" id="" /><p className="text-[#727272] ml-[8px]">Id</p></span></th>
                        <th><span className="flex"><p className="text-[#727272] ml-[8px]">Date</p> <img src="/images/dashboard-table-arrow.svg" alt="" /></span></th>
                        <th><span className="flex"><p className="text-[#727272] ml-[8px]">Client</p><img src="/images/dashboard-table-arrow.svg" alt="" /></span></th>
                        <th><span className="flex"><p className="text-[#727272] ml-[8px]">Company</p><img src="/images/dashboard-table-arrow.svg" alt="" /></span></th>
                        <th><span className="flex"><p className="text-[#727272] ml-[8px]">Payment</p><img src="/images/dashboard-table-arrow.svg" alt="" /></span></th>
                        <th><span className="flex"><p className="text-[#727272] ml-[8px]">Status</p><img src="/images/dashboard-table-arrow.svg" alt="" /></span></th>
                        <th><span className="flex"><p className="text-[#727272] ml-[8px]">Action</p><img src="/images/dashboard-table-arrow.svg" alt="" /></span></th>
                    </tr>
                    </thead>
                    <tbody className="border border-2">
                        {
                            members.map((l, k) => {
                                return(
                                    <tr className="h-[48px]">
                                    <td className=""><input type="checkbox" name="" id="" /> 1528902 </td>
                                    <td><span className="flex"><img src="/images/dashboard-calender.svg" alt="" />  <p className="text-[#727272] font-medium">18/09/2016</p></span> </td>
                                    <td className="font-medium text-[#727272]">Leslie Alexander</td>
                                    <td className="font-medium text-[#727272]">Abstergo Ltd.</td>
                                    <td>$2.120</td>
                                    <td><span className=""><button className="rounded-[20px] bg-[#EEF5F0] px-[10px] text-[#589E67] flex items-center"><img src="/images/dashboard-table-button-dot.svg" alt="" className="mr-[8px]"/>  COMPELETED</button></span></td>
